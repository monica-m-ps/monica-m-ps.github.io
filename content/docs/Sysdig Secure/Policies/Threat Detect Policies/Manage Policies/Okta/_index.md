...
aliases:
  - /en/okta-policy/
description: "Okta policies evaluate Okta logs in Sysdig Cloud. You can edit them, duplicate to create a custom version, or create a new list matching policy from scratch."
---
...
To create an Okta policy:

1. Log in to Sysdig Secure and select **Policies** > **Threat Detection** > **Runtime Policies**.

2. Click **Add Policy** and select **Okta**.

## Configure an Okta Policy
...
2. Filter for **Managed Policy** and **Okta**. 

3. You can edit a managed policy, duplicate it to create a custom policy, or click **+ Add Policy**, and choose **Okta** to configure it from scratch.